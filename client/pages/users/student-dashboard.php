...
<body>
              ...
              <div class="queue-content">
                <div class="queue-main">
                  ...
                  <div class="queue-details">
                    <h4 style="font-size: 1.1rem; font-weight: 800; color: #1e293b; margin-bottom: 6px;">Active Queue
                      Booking</h4>
                    <div style="display: flex; flex-direction: column; gap: 4px;">
                      <p
                        style="font-size: 0.85rem; font-weight: 600; color: #64748b; margin: 0; display: flex; align-items: center; gap: 6px;">
                        <i class="fas fa-calendar-alt"></i> <?php echo $bDate->format('F d, Y'); ?>
                      </p>
                      <p
                        style="font-size: 0.85rem; font-weight: 600; color: #94a3b8; margin: 0; display: flex; align-items: center; gap: 6px;">
                ...
                <?php if ($status_id != 1): ?>
                  <button class="btn-cancel-booking" data-id="<?php echo $booking['schedule_id']; ?>"
                    style="padding: 10px 20px; border-radius: 12px; font-weight: 700;">
                    Cancel Booking
                  </button>
                <?php endif; ?>
              </div>
  ...
  <nav class="mobile-nav">
    ...
    <a href="#" class="mobile-nav-item logout-nav-item" onclick="event.preventDefault(); document.getElementById('logout-modal').classList.add('active');">
